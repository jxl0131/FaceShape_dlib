...
test_dir = "/data/home/xinlongji/FaceswapMetrics/faces/reference"
sv_dir = "/data/home/xinlongji/FaceswapMetrics/faces/refs_diff_shape_dlib"
...
def get_face_shape(imagepath):
  ...
  for (x,y,w,h) in faces:
      ...
      for i in range(0,cols):
          #enters if when change in pixel color is detected
          if forehead[forehead_mid[1],min(forehead_mid[0]+i,forehead.shape[1]-1)].all()!=pixel_value.all():
